...
public class LibraryMain {
   private static LibraryBook[] LibrarybookArray = new LibraryBook[100];// 가변길이 매개변수를 사용하고싶다
   ...
   public static void main(String[] args) {
      ...
      while(flage) {
         ...
         System.out.println("-------------------------------------------------------------------------");
         System.out.println("1. 신규 도서 등록 | 2. 대출 가능 여부 | 3. 등록 도서 삭제 | 4. 보유 도서 목록 | 5. 종료");
         System.out.println("-------------------------------------------------------------------------");
         System.out.print("선택 > ");
       ...
       for(int i = 0 ; i < LibrarybookArray.length ; i++) {
         if(LibrarybookArray[i] != null) {
          if(searchBook.equals(LibrarybookArray[i].getBookName())) {
             ...
             System.out.println("대출 가능 권 수 : " + LibrarybookArray[i].getBookCnt() + "권");
             }
       ...
       for(int i = 0 ; i < LibrarybookArray.length ; i++) {
         if(LibrarybookArray[i] != null) {
          if(searchBook.equals(LibrarybookArray[i].getBookName())) {
             ...
             if(answer.equals("y")) {
			  	 LibrarybookArray[i] = null;  // 윤은진님 작성 
//            	 LibrarybookArray[i].setBookCnt(0); //  오성철 작성
